...
const VALIDATION_MESSAGES = {
  nome: {
    ...
    minlength: 'Preencha o nome Senha entre 3 e 40 caracteres',
    maxlength: 'Preencha o nome Senha entre 3 e 40 caracteres',
    rangeLength: 'Preencha o nome Senha entre 3 e 40 caracteres',
  },
  email: {
  ...
  senha: {
    required: 'Campo obrigatório',
    minlength: 'Preencha o campo Senha entre 6 e 12 caracteres',
    maxlength: 'Preencha o campo Senha entre 6 e 12 caracteres',
    rangeLength: 'Preencha o campo Senha entre 6 e 12 caracteres',
  },
  confirmPassword: {
    required: 'Required',
